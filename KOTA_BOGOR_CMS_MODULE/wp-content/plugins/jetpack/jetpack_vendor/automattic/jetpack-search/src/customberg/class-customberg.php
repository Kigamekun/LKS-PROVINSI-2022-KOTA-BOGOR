<?php
/**
 * A class that adds a search customization interface to admin.
 *
...
/**
 * Responsible for adding a search customization interface to admin.
 *
 * @package Automattic\Jetpack\Search
 */
class Customberg {
	...
	/**
	 * Adds a admin page without adding a sidebar submenu item.
	 */
	...
	/**
	 * Determine if the requisite page should be added to admin.
	 *
	 * @return boolean
	 */
