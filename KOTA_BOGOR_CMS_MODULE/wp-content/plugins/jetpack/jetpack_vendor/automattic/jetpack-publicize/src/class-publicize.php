			...
			if ( $publicize_error ) {
				...
				switch ( $code ) {
					...
					case 'empty_state':
						...
						$error = sprintf( __( 'No user information was included in your request. Please make sure that your user account has connected to Jetpack. Connect your user account by going to the <a href="%s">Jetpack page</a> within admin.', 'jetpack-publicize-pkg' ), \Jetpack::admin_url() );
						break;
					default:
