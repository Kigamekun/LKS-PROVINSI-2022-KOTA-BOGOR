...
class Jetpack {
	...
	private function __construct() {
		...
		/*
		 * If enabled, point edit post, page, and comment links to Calypso instead of admin.
	...
	public function configure() {
		...
		$config->ensure(
			...
			array(
				'slug'       => 'jetpack',
				'admin_page' => '/admin/admin.php?page=jetpack',
			)
		);
...
// phpcs:disable WordPress.WP.CapitalPDangit.Misspelled
	...
	public static function activate_default_modules(
		...
		// Check each module for fatal errors, a la admin/plugins.php::activate before activating.
		if ( $send_state_messages ) {
			self::restate();
...
<p><?php echo esc_html( $message ); ?></p>
	...
	public static function get_activation_source( $referer_url ) {
		...
		$plugins_install_path = wp_parse_url( admin_url( 'plugin-install.php' ), PHP_URL_PATH );// /admin/plugin-install.php
	...
	public function admin_init() {
		...
		// Add custom column in admin/users.php to show whether user is linked.
	 ...
	 * 8 - User is redirected back to admin/index.php?page=jetpack with state:message=authorized
	 *     Done!
	 */
...
<div id="message" class="jetpack-message jetpack-err">
	 ...
	 * @param bool|string $redirect If true, will redirect back to Jetpack admin landing page after connection.
	...
	public static function is_akismet_active() {
		...
		// Do not used the cache result in admin or REST API requests if the key isn't valid, in case someone is actively renewing, etc.
