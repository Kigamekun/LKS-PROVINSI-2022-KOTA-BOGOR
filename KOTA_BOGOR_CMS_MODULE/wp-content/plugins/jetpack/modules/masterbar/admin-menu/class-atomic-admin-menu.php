...
class Atomic_Admin_Menu extends Admin_Menu {
	...
	public function get_preferred_view( $screen, $fallback_global_preference = true ) {
		...
		/**
		 * When Jetpack SSO is disabled, we need to force Calypso because it might create confusion to be redirected to admin.
		 * Furthermore, because we don't display the quick switcher, users having an admin interface by default won't be able to go back to the Calyso version.
		 */
