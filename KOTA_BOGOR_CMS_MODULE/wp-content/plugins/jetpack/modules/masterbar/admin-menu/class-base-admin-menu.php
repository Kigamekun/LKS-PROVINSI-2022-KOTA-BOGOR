...
abstract class Base_Admin_Menu {
	...
	public function set_menu_item( $item, $position = null ) {
		...
		// Inspired by https://core.trac.wordpress.org/browser/trunk/src/admin/menu.php?rev=49837#L160.
		if ( null === $position ) {
			...
			<div class="screen-options-tab__dropdown" data-testid="screen-options-dropdown">
				<div class="screen-switcher">
					...
					<button class="screen-switcher__button"  data-view="classic">
						...
						<?php esc_html_e( 'The classic admin WordPress interface.', 'jetpack' ); ?>
					</button>
				</div>
			</div>
		</div>
	...
	/**
	 * Whether to use admin pages rather than Calypso.
	 *
	 * Options:
