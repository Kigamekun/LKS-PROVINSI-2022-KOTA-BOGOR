...
class Masterbar {
	...
	public function add_my_sites_submenu( $wp_admin_bar ) {
		...
		if ( current_user_can( 'edit_theme_options' ) ) {
			...
			if ( is_admin() ) {
				// In admin the `return` query arg will return to that page after closing the Customizer.
