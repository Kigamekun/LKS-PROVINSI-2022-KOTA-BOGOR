...
class Jetpack_Likes {
	...
	/**
	 * Load the CSS needed for the admin area.
	 */
	...
	/**
	 * Add "Likes" column data to the post edit table in admin.
	 *
	...
	/**
	 * Add a "Likes" column header to the post edit table in admin.
	 *
	 * @param array $columns - array of columns in admin.
	 */
