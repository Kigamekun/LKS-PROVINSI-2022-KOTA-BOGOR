...
class Jetpack_Custom_CSS {
	...
	public static function publish_box() {
		...
		<div id="minor-publishing">
			<div id="misc-publishing-actions">
				...
				/**
				 * Allows addition of elements to the submit box for custom css on the admin side.
				 *
				 * @module custom-css
				 *
				 * @since 2.0.3
	...
	/**
	 * Adds a filter to the redirect location in `admin/revisions.php`.
	 */
	...
	/**
	 * Filters the redirect location in `admin/revisions.php`.
	 *
