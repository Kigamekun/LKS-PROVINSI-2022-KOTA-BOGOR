...
class Admin_Bar_Notice {
	...
	public function add_inline_styles() {
		...
		$hide_wording_on_mobile = '#admin-bar-jetpack-scan-notice .is-hidden { display:none; } @media screen and (max-width: 959px ) { #wpadminbar #admin-bar-jetpack-scan-notice { width:32px; } #wpadminbar #admin-bar-jetpack-scan-notice a { color: transparent!important; } }';
		$style                  = '#admin-bar-jetpack-scan-notice svg { float:left; margin-top: 4px; margin-right: 6px; width: 18px; height: 22px; }' . $hide_wording_on_mobile;
		if ( is_rtl() ) {
			$style = '#admin-bar-jetpack-scan-notice svg { float:right; margin-top: 4px; margin-left: 6px; width: 18px; height: 22px; }' . $hide_wording_on_mobile;
		}
