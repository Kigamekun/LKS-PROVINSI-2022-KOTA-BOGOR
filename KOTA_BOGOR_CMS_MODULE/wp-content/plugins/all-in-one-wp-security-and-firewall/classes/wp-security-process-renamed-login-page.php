...
class AIOWPSecurity_Process_Renamed_Login_Page {
	...
	public static function renamed_login_init_tasks() {
		...
		//case where someone attempting to reach admin
	...
	public static function aiowps_set_404() {
		global $wp_query;
		do_action('aiopws_before_set_404'); //This hook is for themes which produce a fatal error when the rename login feature is enabled and someone visits "admin" slug directly
