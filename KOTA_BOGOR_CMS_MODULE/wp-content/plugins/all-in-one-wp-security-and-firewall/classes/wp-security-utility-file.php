...
class AIOWPSecurity_Utility_File {
	...
	public function __construct() {
		...
		$this->files_and_dirs_to_check = array(
			...
			array('name' => 'admin/index.php', 'path' => ABSPATH."admin/index.php", 'permissions' => '0644'),
			array('name' => 'admin/js/', 'path' => ABSPATH."admin/js/", 'permissions' => '0755'),
			...
			array('name' => 'admin/', 'path' => ABSPATH."admin", 'permissions' => '0755'),
