...
class HMWP_Models_Compatibility
{
    ...
    public function checkCompatibility()
    {
        ...
        add_action(
            'init', function () {
                ...
                if (function_exists('is_user_logged_in') && !is_user_logged_in() && isset($_SERVER['REQUEST_URI'])) {
	                ...
	                //If there is a process that need to access the admin
	    ...
	    if(HMWP_Classes_Tools::isPluginActive('wordfence/wordfence.php')) {
		    ...
		    add_action('init', function () {
			    if(is_admin()) {
				    ...
				    //Add the Wordfence menu when the admin path is changed
				    if (is_multisite()) {
        ...
        if (HMWP_Classes_Tools::isPluginActive('sitepress-multilingual-cms/sitepress.php') ) {
            //WPML checks the HTTP_REFERER based on admin and not the custom admin path
    ...
    /**
     * Add the Must-Use plugin to make sure is loading for the custom admin path every time
     */
