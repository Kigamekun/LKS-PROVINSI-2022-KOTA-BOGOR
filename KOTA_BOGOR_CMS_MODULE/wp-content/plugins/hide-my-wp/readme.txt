...
Tags: security,firewall,hide,antivirus,wp-login,admin,hide wordpress,hide wp,security plugin
...
Hide WP paths, admin, wp-login, wp-content, plugins, themes, authors, XML-RPC, API, etc. Add 7G Firewall Security, Brute Force protection & more.
...
> <a href="https://demo.wpplugins.tips/admin/">https://demo.wpplugins.tips/admin</a>
...
Protect your WordPress website by hiding the authentication paths like admin, wp-login.php, and wp-login, and change the common WordPress paths like wp-content, wp-includes, uploads, and more.

Hide My WP Ghost is packed with awesome security features:

> <strong>Hide My WP Ghost (over 40 FREE Security Features):</strong>
>
> *   Hide WordPress admin, and show 404 error or a custom page
> *   Hide WordPress wp-login.php, and show 404 error or a custom page
> *   Change the admin and wp-login URLs
...
== Screenshots ==
1. Change admin and wp-login.php paths and show 404 Error instead. This is a very important WordPress Security step.
...
9. Customize the admin path while logged in as an administrator
...
* Update - Add the option to hide the admin path for non-admin users
...
* Update - Compatibility with Wordfence Security Scan when the admin is hidden
...
* Update - Added 403 Error Code option for the admin and wp-login.php redirects
...
* Update - Compatibility with WPML when setting custom admin and admin-ajax
...
* Update - Prevent loading the style from admin in the custom login page
...
* Fixed - admin issue on Godaddy hostin plan
