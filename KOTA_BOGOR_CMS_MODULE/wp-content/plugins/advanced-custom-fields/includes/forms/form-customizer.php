...
(function($) {
	...
	// an attempt was made to remove the WYSIWYG unique ID, but this caused multiple issues in the admin and altimately doesn't make sense with the tinymce rule that all editors must have a unique ID.
	// source: admin/js/customize-widgets.js
