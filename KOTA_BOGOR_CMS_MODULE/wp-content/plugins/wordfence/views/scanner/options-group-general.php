			...
			<div class="wf-block-content">
				<ul class="wf-block-list">
					...
					$options = array(
						...
						array('key' => 'scansEnabled_coreUnknown', 'label' => __('Scan admin and wp-includes for files not bundled with WordPress', 'wordfence'), 'helpLink' => wfSupportController::supportURL(wfSupportController::ITEM_SCAN_OPTION_UNKNOWN_CORE)),
