<?php
 /*
 Plugin Name: Change admin login
 Plugin URI: https://wordpress.org/plugins/change-admin-login/
 Description: Change admin login to whatever you want. example: http://www.example.com/my-login. Go under Settings and then click on "Permalinks" and change your URL under "Change admin login".
 Version: 1.1.0
 Author: Nuno Morais Sarmento
 Author URI: https://www.nuno-sarmento.com
 Text Domain: change-admin-login
...
if( ! defined( 'NS_Change_WP_Admin_Login_Name' ) ) {
	define( 'NS_Change_WP_Admin_Login_Name', 'Change admin login' );
}
...
// i18n ----------------------------
--------------------------------------------- */
load_plugin_textdomain( 'change-admin-login', false, basename( dirname( __FILE__ ) ) . '/languages' );

/* ------------------------------------------
// Includes ---------------------------
--------------------------------------------- */
require_once NS_Change_WP_Admin_Login_Path . 'includes/class-change-admin-login.php';
