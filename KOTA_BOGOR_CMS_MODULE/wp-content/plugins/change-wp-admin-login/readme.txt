=== Change admin login ===
Tags:              change wp-login, rename wp-login, admin, login, wp-login, wp-login.php, custom login url
...
*Change admin login* is a light plugin that allows you easily and safely to change admin to anything you want. It does not rename or change files in core. It simply intercepts page requests and works on any WordPress website. After you activate this plugin the admin directory and wp-login.php page will become unavailable, so you should bookmark or remember the url. Disable this plugin brings your site back exactly to the state it was before.


== Support ==

**Like this plugin?** Please [Rate It](https://wordpress.org/support/plugin/change-admin-login/reviews/?filter=5) or [Buy me a coffee](https://ko-fi.com/nunosarmento)

**Have a problem?** Please write a message in the [WordPress Support Forum](https://wordpress.org/support/plugin/change-admin-login/)


== How to use the plugin ==

Go under Settings and then click on "Permalinks" and change your URL under "Change admin login".
...
When someone tries to access the wp-login.php page or the admin directory while not logged in will be redirect to the page that you defined on the redirect custom field.
...
2. Search for *Change admin login*.
3. Download and activate it.
4. Go under Settings and then click on "Permalinks" and change your URL under "Change admin login"
5. You can change this anytime, just go back to Settings › Permalinks › Change admin login.
...
/wp-content/plugins/change-admin-login
...
No, Buddyboss has their own admin redirect functions.

= Does it work with BuddyPress? =
No, BuddyPress has their own admin redirect functions.
...
= 1.0.1 =
* Add automatic redirect for when someone tries to access the wp-login.php page or the admin directory while not logged in will be redirected to the website homepage.
