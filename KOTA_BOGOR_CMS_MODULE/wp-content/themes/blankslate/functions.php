...
add_action( 'widgets_init', 'slider_widget_init' );
function slider_widget_init() {
register_sidebar( array(
'name' => esc_html__( 'Slider Widget Area', 'blankslate' ),
...
add_action( 'widgets_init', 'login_widget_init' );
function login_widget_init() {
register_sidebar( array(
'name' => esc_html__( 'Login Widget Area', 'blankslate' ),
